...
@Import({FrontPermissionServiceImpl.class,RoleServiceImpl.class})
class FrontPermissionServiceImplTest extends BaseDbUnitTest {

    @Resource
    private FrontPermissionServiceImpl frontpermissionService;
...
//    private RoleService roleService;
    ...
    @Test
    void getRoleMenuIds() {
//        frontpermissionService.getRoleMenuIds(112L);
    }

    @Test
    void assignRoleMenu() {

//        frontpermissionService.assignRoleMenu(112L, new HashSet<Long>());
    }
    ...
    void getUserRoleIdListByUserId() {
        ...
        frontpermissionService.getUserRoleIdListByUserId(112L);
    }

    @Test
    void assignUserRole() {

        frontpermissionService.assignUserRole(112L,new HashSet<Long>());

        UserRoleDO user = new UserRoleDO();
        user.setId(0L);
        user.setUserId(0L);
        user.setRoleId(0L);
        ...
        List<UserRoleDO> us = new ArrayList<>();
        us.add(user);
        Mockito.when(userRoleMapper.selectListByUserId(112L)).
                thenReturn(us);
...
//        frontpermissionService.getUserRoleIdListByRoleId(112L);
    }

    @Test
    void getSimpleUserListByRoleId() {

//        frontpermissionService.getSimpleUserListByRoleId(112L);
    }

    @Test
    void getRoleMenuList() {

        frontpermissionService.getRoleMenuList(new ArrayList<>());
    }
}