...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_LOGIN_MOBILE_NOT_FOUND = new ErrorCode(1002000007, "登录失败，手机号不存在");
...
//    ErrorCode INNER_ROLE_MODIFY_FAILED = new ErrorCode(1002002006, "内置用户不能修改");
    ...
    ErrorCode SMS_CODE_SEND_TOO_FAST = new ErrorCode(1002014005, "短信发送过于频繁");
    ...
    ErrorCode DELEGATION_CANCELED = new ErrorCode(1002020005, "委托已被取消");
    ErrorCode DELEGATION_PROJECT_ID_DUPLICATE = new ErrorCode(1002020006, "项目编号已存在");
    ...
    ErrorCode CONTRACT_TABLE_NOT_FILLED = new ErrorCode(1002023001, "合同表格未填写");
